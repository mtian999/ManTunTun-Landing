...
export const TIERS_ZH: Array<Tier> = [
  {
    ...
    description: "基础功能完全免费，助您**更高效**地工作。",
    features: ["免费使用", "基础专注力提醒", "可爱ManTunTun动画"],
    buttonText: "立即使用",
    buttonColor: "primary",
    buttonVariant: "solid",
  },
  {
    ...
    description: "解锁更多个性化设置，提升您的专注体验，让您**更高效**。",
    price: "定制",
    features: ["自定义网站列表", "个性化倒计时设置", "高级统计功能"],
    buttonText: "了解更多",
    buttonColor: "default",
    buttonVariant: "flat",
  },
...
export const TIERS_EN: Array<Tier> = [
  {
    ...
    href: siteConfig.openSourceURL || "#",
    description:
      "Basic features are completely free to help you improve efficiency.",
    features: [
      "Free to use",
      "Basic focus reminders",
  ...
  },
  {
    ...
    href: siteConfig.authors[0].twitter || "#",
    description:
      "Unlock more personalized settings to enhance your focus experience.",
    price: "Customize",
    features: [
      "Custom website list",
